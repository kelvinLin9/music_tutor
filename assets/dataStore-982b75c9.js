 ...
 */const yn=new Ci("@firebase/auth");function Tl(n,...e){yn.logLevel<=jt.WARN&&yn.warn(`Auth (${ut}): ${n}`,...e)}function hn(n,...e){yn.logLevel<=jt.ERROR&&yn.error(`Auth (${ut}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function se(n,...e){throw kr(n,...e)}function de(n,...e){return kr(n,...e)}function Di(n,e,t){const r=Object.assign(Object.assign({},Il()),{[e]:t});return new Ar("auth","Firebase",r).create(e,{appName:n.name})}function bl(n,e,t){const r=t;if(!(e instanceof r))throw r.name!==e.constructor.name&&se(n,"argument-error"),Di(n,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function kr(n,...e){if(typeof n!="string"){const t=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=n.name),n._errorFactory.create(t,...r)}return Ri.create(n,...e)}function y(n,e,...t){if(!n)throw kr(e,...t)}function me(n){const e="INTERNAL ASSERTION FAILED: "+n;throw hn(e),new Error(e)}function ye(n,e){n||me(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ht{constructor(e,t){this.shortDelay=e,this.longDelay=t,ye(t>e,"Short delay should be less than long delay!"),this.isMobile=al()||cl()}get(){return Al()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cl=new Ht(3e4,6e4);function Re(n,e){return n.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:n.tenantId}):e}async function De(n,e,t,r,o={}){return Ni(n,o,async()=>{let a={},l={};r&&(e==="GET"?l=r:a={body:JSON.stringify(r)});const h=qt(Object.assign({key:n.config.apiKey},l)).slice(1),d=await n._getAdditionalHeaders();return d["Content-Type"]="application/json",n.languageCode&&(d["X-Firebase-Locale"]=n.languageCode),Oi.fetch()(Vi(n,n.config.apiHost,t,h),Object.assign({method:e,headers:d,referrerPolicy:"no-referrer"},a))})}async function Ni(n,e,t){n._canInitEmulator=!1;const r=Object.assign(Object.assign({},kl),e);try{const o=new Sl(n),a=await Promise.race([t(),o.promise]);o.clearNetworkTimeout();const l=await a.json();if("needConfirmation"in l)throw cn(n,"account-exists-with-different-credential",l);if(a.ok&&!("errorMessage"in l))return l;{const h=a.ok?l.errorMessage:l.error.message,[d,m]=h.split(" : ");if(d==="FEDERATED_USER_ID_ALREADY_LINKED")throw cn(n,"credential-already-in-use",l);if(d==="EMAIL_EXISTS")throw cn(n,"email-already-in-use",l);if(d==="USER_DISABLED")throw cn(n,"user-disabled",l);const g=r[d]||d.toLowerCase().replace(/[_\s]+/g,"-");if(m)throw Di(n,g,m);se(n,g)}}catch(o){if(o instanceof Dn)throw o;se(n,"network-request-failed",{message:String(o)})}}async function $t(n,e,t,r,o={}){const a=await De(n,e,t,r,o);return"mfaPendingCredential"in a&&se(n,"multi-factor-auth-required",{_serverResponse:a}),a}function Vi(n,e,t,r){const o=`${e}${t}?${r}`;return n.config.emulator?Cr(n.config,o):`${n.config.apiScheme}://${o}`}class Sl{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,r)=>{this.timer=setTimeout(()=>r(de(this.auth,"network-request-failed")),Cl.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function cn(n,e,t){const r={appName:n.name};t.email&&(r.email=t.email),t.phoneNumber&&(r.phoneNumber=t.phoneNumber);const o=de(n,e,r);return o.customData._tokenResponse=t,o}async function Rl(n,e){return De(n,"GET","/v2/recaptchaConfig",Re(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Dl(n,e){return De(n,"POST","/v1/accounts:delete",e)}async function Ol(n,e){return De(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fn(n,e,t){return`firebase:${n}:${e}:${t}`}class st{constructor(e,t,r){this.persistence=e,this.auth=t,this.userKey=r;const{config:o,name:a}=this.auth;this.fullUserKey=fn(this.userKey,o.apiKey,a),this.fullPersistenceKey=fn("persistence",o.apiKey,a),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?Ue._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,r="authUser"){if(!t.length)return new st(ge(Ks),e,r);const o=(await Promise.all(t.map(async m=>{if(await m._isAvailable())return m}))).filter(m=>m);let a=o[0]||ge(Ks);const l=fn(r,e.config.apiKey,e.name);let h=null;for(const m of t)try{const g=await m._get(l);if(g){const I=Ue._fromJSON(e,g);m!==a&&(h=I),a=m;break}}catch{}const d=o.filter(m=>m._shouldAllowMigration);return!a._shouldAllowMigration||!d.length?new st(a,e,r):(a=d[0],h&&await a._set(l,h.toJSON()),await Promise.all(t.map(async m=>{if(m!==a)try{await m._remove(l)}catch{}})),new st(a,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $i(n,e=[]){let t;switch(n){case"Browser":t=Gs(G());break;case"Worker":t=`${Gs(G())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${ut}/${r}`}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wl(n,e={}){return De(n,"GET","/v2/passwordPolicy",Re(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dr{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return me("not implemented")}_getIdTokenResponse(e){return me("not implemented")}_linkToIdToken(e,t){return me("not implemented")}_getReauthenticationResolver(e){return me("not implemented")}}async function ou(n,e){return De(n,"POST","/v1/accounts:update",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ur(n,e){return $t(n,"POST","/v1/accounts:signInWithPassword",Re(n,e))}async function au(n,e){return De(n,"POST","/v1/accounts:sendOobCode",Re(n,e))}async function dr(n,e){return au(n,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cu(n,e){return $t(n,"POST","/v1/accounts:signInWithEmailLink",Re(n,e))}async function lu(n,e){return $t(n,"POST","/v1/accounts:signInWithEmailLink",Re(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function it(n,e){return $t(n,"POST","/v1/accounts:signInWithIdp",Re(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dt{constructor(){this.providerId=dt.PROVIDER_ID}static credential(e,t){return Lt._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=Or.parseLink(t);return y(r,"argument-error"),Lt._fromEmailAndCode(e,r.code,r.tenantId)}}dt.PROVIDER_ID="password";dt.EMAIL_PASSWORD_SIGN_IN_METHOD="password";dt.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ke extends Wt{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return je._fromParams({providerId:ke.PROVIDER_ID,signInMethod:ke.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return ke.credentialFromTaggedObject(e)}static credentialFromError(e){return ke.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return ke.credential(t,r)}catch{return null}}}ke.GOOGLE_SIGN_IN_METHOD="google.com";ke.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Se extends Wt{constructor(){super("twitter.com")}static credential(e,t){return je._fromParams({providerId:Se.PROVIDER_ID,signInMethod:Se.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return Se.credentialFromTaggedObject(e)}static credentialFromError(e){return Se.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:r}=e;if(!t||!r)return null;try{return Se.credential(t,r)}catch{return null}}}Se.TWITTER_SIGN_IN_METHOD="twitter.com";Se.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hr(n,e){return $t(n,"POST","/v1/accounts:signUp",Re(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gi(n,e,t=!1){const r="signIn",o=await Ki(n,r,e),a=await qe._fromIdTokenResponse(n,r,o);return t||await n._updateCurrentUser(a.user),a}async function mu(n,e){return Gi(ve(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Yi(n){const e=ve(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Xh(n,e,t){var r;const o=ve(n),a={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};if(!((r=o._getRecaptchaConfig())===null||r===void 0)&&r.emailPasswordEnabled){const l=await ot(o,a,"getOobCode",!0);t&&fr(o,l,t),await dr(o,l)}else t&&fr(o,a,t),await dr(o,a).catch(async l=>{if(l.code==="auth/missing-recaptcha-token"){console.log("Password resets are protected by reCAPTCHA for this project. Automatically triggering the reCAPTCHA flow and restarting the password reset flow.");const h=await ot(o,a,"getOobCode",!0);t&&fr(o,h,t),await dr(o,h)}else return Promise.reject(l)})}async function Zh(n,e,t){var r;const o=ve(n),a={returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"};let l;if(!((r=o._getRecaptchaConfig())===null||r===void 0)&&r.emailPasswordEnabled){const m=await ot(o,a,"signUpPassword");l=hr(o,m)}else l=hr(o,a).catch(async m=>{if(m.code==="auth/missing-recaptcha-token"){console.log("Sign-up is protected by reCAPTCHA for this project. Automatically triggering the reCAPTCHA flow and restarting the sign-up flow.");const g=await ot(o,a,"signUpPassword");return hr(o,g)}throw m});const h=await l.catch(m=>{throw m.code==="auth/password-does-not-meet-requirements"&&Yi(n),m}),d=await qe._fromIdTokenResponse(o,"signIn",h);return await o._updateCurrentUser(d.user),d}function ef(n,e,t){return mu(j(n),dt.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&Yi(n),r})}function gu(n,e,t,r){return j(n).onIdTokenChanged(e,t,r)}function _u(n,e,t){return j(n).beforeAuthStateChanged(e,t)}function Xs(n,e,t,r){return j(n).onAuthStateChanged(e,t,r)}function tf(n){return j(n).signOut()}const In="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function he(){return window}function Eu(n){he().location.href=n}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eo(){return typeof he().WorkerGlobalScope<"u"&&typeof he().importScripts=="function"}async function Au(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Pu(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function ku(){return eo()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function so(n,e){return e?ge(e):(y(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gu(n,e={}){return De(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zu=new Ht(3e4,6e4);function ni(){const n=he().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function ed(n){return new Promise((e,t)=>{var r,o,a;function l(){ni(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{ni(),t(de(n,"network-request-failed"))},timeout:Zu.get()})}if(!((o=(r=he().gapi)===null||r===void 0?void 0:r.iframes)===null||o===void 0)&&o.Iframe)e(gapi.iframes.getContext());else if(!((a=he().gapi)===null||a===void 0)&&a.load)l();else{const h=Jl("iframefcb");return he()[h]=()=>{gapi.load?l():t(de(n,"network-request-failed"))},Wi(`https://apis.google.com/js/api.js?onload=${h}`).catch(d=>t(d))}}).catch(e=>{throw mn=null,e})}let mn=null;function td(n){return mn=mn||ed(n),mn}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pr="webStorageSupport";class vd{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Zi,this._completeRedirectFn=$u,this._overrideRedirectResult=ju}async _openPopup(e,t,r,o){var a;ye((a=this.eventManagers[e._key()])===null||a===void 0?void 0:a.manager,"_initialize() not called before _openPopup()");const l=await si(e,t,r,yr(),o);return pd(e,l,Vr())}async _openRedirect(e,t,r,o){await this._originValidation(e);const a=await si(e,t,r,yr(),o);return Eu(a),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:o,promise:a}=this.eventManagers[t];return o?Promise.resolve(o):(ye(a,"If manager is not set, promise should be"),a)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await cd(e),r=new zu(e);return t.register("authEvent",o=>(y(o==null?void 0:o.authEvent,e,"invalid-auth-event"),{status:r.onEvent(o.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(pr,{type:pr},o=>{var a;const l=(a=o==null?void 0:o[0])===null||a===void 0?void 0:a[pr];l!==void 0&&t(!!l),se(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Qu(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Hi()||Rr()||On()}}const Id=vd;var ii="@firebase/auth",oi="1.2.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const at=new Ci("@firebase/firestore");function bn(n,...e){if(at.logLevel<=jt.DEBUG){const t=e.map(Fr);at.debug(`Firestore (${ht}): ${n}`,...t)}}function Mr(n,...e){if(at.logLevel<=jt.ERROR){const t=e.map(Fr);at.error(`Firestore (${ht}): ${n}`,...t)}}function ao(n,...e){if(at.logLevel<=jt.WARN){const t=e.map(Fr);at.warn(`Firestore (${ht}): ${n}`,...t)}}function Fr(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function C(n="Unexpected state"){const e=`FIRESTORE (${ht}) INTERNAL ASSERTION FAILED: `+n;throw Mr(e),new Error(e)}function ee(n,e){n||C()}function Kt(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ci="ok",Sd="cancelled",Ct="unknown",A="invalid-argument",Rd="deadline-exceeded",Dd="not-found",Od="permission-denied",vr="unauthenticated",Nd="resource-exhausted",ct="failed-precondition",Vd="aborted",Ld="out-of-range",co="unimplemented",Md="internal",Fd="unavailable";class v extends Dn{constructor(e,t){super(e,t),this.code=e,this.message=t,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class we{constructor(e){this.binaryString=e}static fromBase64String(e){const t=function(o){try{return atob(o)}catch(a){throw typeof DOMException<"u"&&a instanceof DOMException?new Zd("Invalid base64 string: "+a):a}}(e);return new we(t)}static fromUint8Array(e){const t=function(o){let a="";for(let l=0;l<o.length;++l)a+=String.fromCharCode(o[l]);return a}(e);return new we(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(t){return btoa(t)}(this.binaryString)}toUint8Array(){return function(t){const r=new Uint8Array(t.length);for(let o=0;o<t.length;o++)r[o]=t.charCodeAt(o);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return V(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}we.EMPTY_BYTE_STRING=new we("");const eh=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function He(n){if(ee(!!n),typeof n=="string"){let e=0;const t=eh.exec(n);if(ee(!!t),t[1]){let o=t[1];o=(o+"000000000").substr(0,9),e=Number(o)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:O(n.seconds),nanos:O(n.nanos)}}function O(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function xt(n){return typeof n=="string"?we.fromBase64String(n):we.fromUint8Array(n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function po(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function mo(n){const e=n.mapValue.fields.__previous_value__;return po(e)?mo(e):e}function Ut(n){const e=He(n.mapValue.fields.__local_write_time__.timestampValue);return new te(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const un={fields:{__type__:{stringValue:"__max__"}}};function $e(n){return"nullValue"in n?0:"booleanValue"in n?1:"integerValue"in n||"doubleValue"in n?2:"timestampValue"in n?3:"stringValue"in n?5:"bytesValue"in n?6:"referenceValue"in n?7:"geoPointValue"in n?8:"arrayValue"in n?9:"mapValue"in n?po(n)?4:function(t){return(((t.mapValue||{}).fields||{}).__type__||{}).stringValue==="__max__"}(n)?9007199254740991:10:C()}function An(n,e){if(n===e)return!0;const t=$e(n);if(t!==$e(e))return!1;switch(t){case 0:case 9007199254740991:return!0;case 1:return n.booleanValue===e.booleanValue;case 4:return Ut(n).isEqual(Ut(e));case 3:return function(o,a){if(typeof o.timestampValue=="string"&&typeof a.timestampValue=="string"&&o.timestampValue.length===a.timestampValue.length)return o.timestampValue===a.timestampValue;const l=He(o.timestampValue),h=He(a.timestampValue);return l.seconds===h.seconds&&l.nanos===h.nanos}(n,e);case 5:return n.stringValue===e.stringValue;case 6:return function(o,a){return xt(o.bytesValue).isEqual(xt(a.bytesValue))}(n,e);case 7:return n.referenceValue===e.referenceValue;case 8:return function(o,a){return O(o.geoPointValue.latitude)===O(a.geoPointValue.latitude)&&O(o.geoPointValue.longitude)===O(a.geoPointValue.longitude)}(n,e);case 2:return function(o,a){if("integerValue"in o&&"integerValue"in a)return O(o.integerValue)===O(a.integerValue);if("doubleValue"in o&&"doubleValue"in a){const l=O(o.doubleValue),h=O(a.doubleValue);return l===h?En(l)===En(h):isNaN(l)&&isNaN(h)}return!1}(n,e);case 9:return fo(n.arrayValue.values||[],e.arrayValue.values||[],An);case 10:return function(o,a){const l=o.mapValue.fields||{},h=a.mapValue.fields||{};if(fi(l)!==fi(h))return!1;for(const d in l)if(l.hasOwnProperty(d)&&(h[d]===void 0||!An(l[d],h[d])))return!1;return!0}(n,e);default:return C()}}function Bt(n,e){return(n.values||[]).find(t=>An(t,e))!==void 0}function Pn(n,e){if(n===e)return 0;const t=$e(n),r=$e(e);if(t!==r)return V(t,r);switch(t){case 0:case 9007199254740991:return 0;case 1:return V(n.booleanValue,e.booleanValue);case 2:return function(a,l){const h=O(a.integerValue||a.doubleValue),d=O(l.integerValue||l.doubleValue);return h<d?-1:h>d?1:h===d?0:isNaN(h)?isNaN(d)?0:-1:1}(n,e);case 3:return pi(n.timestampValue,e.timestampValue);case 4:return pi(Ut(n),Ut(e));case 5:return V(n.stringValue,e.stringValue);case 6:return function(a,l){const h=xt(a),d=xt(l);return h.compareTo(d)}(n.bytesValue,e.bytesValue);case 7:return function(a,l){const h=a.split("/"),d=l.split("/");for(let m=0;m<h.length&&m<d.length;m++){const g=V(h[m],d[m]);if(g!==0)return g}return V(h.length,d.length)}(n.referenceValue,e.referenceValue);case 8:return function(a,l){const h=V(O(a.latitude),O(l.latitude));return h!==0?h:V(O(a.longitude),O(l.longitude))}(n.geoPointValue,e.geoPointValue);case 9:return function(a,l){const h=a.values||[],d=l.values||[];for(let m=0;m<h.length&&m<d.length;++m){const g=Pn(h[m],d[m]);if(g)return g}return V(h.length,d.length)}(n.arrayValue,e.arrayValue);case 10:return function(a,l){if(a===un&&l===un)return 0;if(a===un)return 1;if(l===un)return-1;const h=a.fields||{},d=Object.keys(h),m=l.fields||{},g=Object.keys(m);d.sort(),g.sort();for(let I=0;I<d.length&&I<g.length;++I){const b=V(d[I],g[I]);if(b!==0)return b;const w=Pn(h[d[I]],m[g[I]]);if(w!==0)return w}return V(d.length,g.length)}(n.mapValue,e.mapValue);default:throw C()}}function pi(n,e){if(typeof n=="string"&&typeof e=="string"&&n.length===e.length)return V(n,e);const t=He(n),r=He(e),o=V(t.seconds,r.seconds);return o!==0?o:V(t.nanos,r.nanos)}function go(n){return!!n&&"arrayValue"in n}function mi(n){return!!n&&"nullValue"in n}function gi(n){return!!n&&"doubleValue"in n&&isNaN(Number(n.doubleValue))}function mr(n){return!!n&&"mapValue"in n}function St(n){if(n.geoPointValue)return{geoPointValue:Object.assign({},n.geoPointValue)};if(n.timestampValue&&typeof n.timestampValue=="object")return{timestampValue:Object.assign({},n.timestampValue)};if(n.mapValue){const e={mapValue:{fields:{}}};return Gt(n.mapValue.fields,(t,r)=>e.mapValue.fields[t]=St(r)),e}if(n.arrayValue){const e={arrayValue:{values:[]}};for(let t=0;t<(n.arrayValue.values||[]).length;++t)e.arrayValue.values[t]=St(n.arrayValue.values[t]);return e}return Object.assign({},n)}class _i{constructor(e,t){this.position=e,this.inclusive=t}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _o{}class fe extends _o{constructor(e,t,r){super(),this.field=e,this.op=t,this.value=r}static create(e,t,r){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,r):new th(e,t,r):t==="array-contains"?new sh(e,r):t==="in"?new ih(e,r):t==="not-in"?new oh(e,r):t==="array-contains-any"?new ah(e,r):new fe(e,t,r)}static createKeyFieldInFilter(e,t,r){return t==="in"?new nh(e,r):new rh(e,r)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&this.matchesComparison(Pn(t,this.value)):t!==null&&$e(this.value)===$e(t)&&this.matchesComparison(Pn(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return C()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}getFirstInequalityField(){return this.isInequality()?this.field:null}}class Ln extends _o{constructor(e,t){super(),this.filters=e,this.op=t,this.S=null}static create(e,t){return new Ln(e,t)}matches(e){return function(r){return r.op==="and"}(this)?this.filters.find(t=>!t.matches(e))===void 0:this.filters.find(t=>t.matches(e))!==void 0}getFlattenedFilters(){return this.S!==null||(this.S=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.S}getFilters(){return Object.assign([],this.filters)}getFirstInequalityField(){const e=this.N(t=>t.isInequality());return e!==null?e.field:null}N(e){for(const t of this.getFlattenedFilters())if(e(t))return t;return null}}class th extends fe{constructor(e,t,r){super(e,t,r),this.key=$.fromName(r.referenceValue)}matches(e){const t=$.comparator(e.key,this.key);return this.matchesComparison(t)}}class nh extends fe{constructor(e,t){super(e,"in",t),this.keys=yo("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class rh extends fe{constructor(e,t){super(e,"not-in",t),this.keys=yo("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function yo(n,e){var t;return(((t=e.arrayValue)===null||t===void 0?void 0:t.values)||[]).map(r=>$.fromName(r.referenceValue))}class sh extends fe{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return go(t)&&Bt(t.arrayValue,this.value)}}class ih extends fe{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&Bt(this.value.arrayValue,t)}}class oh extends fe{constructor(e,t){super(e,"not-in",t)}matches(e){if(Bt(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&!Bt(this.value.arrayValue,t)}}class ah extends fe{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!go(t)||!t.arrayValue.values)&&t.arrayValue.values.some(r=>Bt(this.value.arrayValue,r))}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Th=(()=>({asc:"ASCENDING",desc:"DESCENDING"}))(),bh=(()=>({"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"}))(),Eh=(()=>({and:"AND",or:"OR"}))();class Ah{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function Ir(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function Ph(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function kh(n,e){return Ir(n,e.toTimestamp())}function Rt(n){return ee(!!n),U.fromTimestamp(function(t){const r=He(t);return new te(r.seconds,r.nanos)}(n))}function Br(n,e){return function(r){return new L(["projects",r.projectId,"databases",r.database])}(n).child("documents").child(e).canonicalString()}function Sn(n,e){return Br(n.databaseId,e.path)}function Tr(n,e){const t=function(o){const a=L.fromString(o);return ee(To(a)),a}(e);if(t.get(1)!==n.databaseId.projectId)throw new v(A,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new v(A,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new $(function(o){return ee(o.length>4&&o.get(4)==="documents"),o.popFirst(5)}(t))}function vi(n,e){return Br(n.databaseId,e)}function vo(n){return new L(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function Ii(n,e,t){return{name:Sn(n,e),fields:t.value.mapValue.fields}}function Ch(n,e){return"found"in e?function(r,o){ee(!!o.found),o.found.name,o.found.updateTime;const a=Tr(r,o.found.name),l=Rt(o.found.updateTime),h=o.found.createTime?Rt(o.found.createTime):U.min(),d=new Z({mapValue:{fields:o.found.fields}});return ue.newFoundDocument(a,l,h,d)}(n,e):"missing"in e?function(r,o){ee(!!o.missing),ee(!!o.readTime);const a=Tr(r,o.missing),l=Rt(o.readTime);return ue.newNoDocument(a,l)}(n,e):C()}function Sh(n,e){let t;if(e instanceof wo)t={update:Ii(n,e.key,e.value)};else if(e instanceof vh)t={delete:Sn(n,e.key)};else if(e instanceof Ur)t={update:Ii(n,e.key,e.data),updateMask:Vh(e.fieldMask)};else{if(!(e instanceof Ih))return C();t={verify:Sn(n,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(r=>function(a,l){const h=l.transform;if(h instanceof gh)return{fieldPath:l.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(h instanceof _h)return{fieldPath:l.field.canonicalString(),appendMissingElements:{values:h.elements}};if(h instanceof yh)return{fieldPath:l.field.canonicalString(),removeAllFromArray:{values:h.elements}};if(h instanceof wh)return{fieldPath:l.field.canonicalString(),increment:h.L};throw C()}(0,r))),e.precondition.isNone||(t.currentDocument=function(o,a){return a.updateTime!==void 0?{updateTime:kh(o,a.updateTime)}:a.exists!==void 0?{exists:a.exists}:C()}(n,e.precondition)),t}function Rh(n,e){const t={structuredQuery:{}},r=e.path;e.collectionGroup!==null?(t.parent=vi(n,r),t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(t.parent=vi(n,r.popLast()),t.structuredQuery.from=[{collectionId:r.lastSegment()}]);const o=function(d){if(d.length!==0)return Io(Ln.create(d,"and"))}(e.filters);o&&(t.structuredQuery.where=o);const a=function(d){if(d.length!==0)return d.map(m=>function(I){return{field:rt(I.field),direction:Dh(I.dir)}}(m))}(e.orderBy);a&&(t.structuredQuery.orderBy=a);const l=function(d,m){return d.useProto3Json||Gd(m)?m:{value:m}}(n,e.limit);return l!==null&&(t.structuredQuery.limit=l),e.startAt&&(t.structuredQuery.startAt=function(d){return{before:d.inclusive,values:d.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(d){return{before:!d.inclusive,values:d.position}}(e.endAt)),t}function Dh(n){return Th[n]}function Oh(n){return bh[n]}function Nh(n){return Eh[n]}function rt(n){return{fieldPath:n.canonicalString()}}function Io(n){return n instanceof fe?function(t){if(t.op==="=="){if(gi(t.value))return{unaryFilter:{field:rt(t.field),op:"IS_NAN"}};if(mi(t.value))return{unaryFilter:{field:rt(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(gi(t.value))return{unaryFilter:{field:rt(t.field),op:"IS_NOT_NAN"}};if(mi(t.value))return{unaryFilter:{field:rt(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:rt(t.field),op:Oh(t.op),value:t.value}}}(n):n instanceof Ln?function(t){const r=t.getFilters().map(o=>Io(o));return r.length===1?r[0]:{compositeFilter:{op:Nh(t.op),filters:r}}}(n):C()}function Vh(n){const e=[];return n.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function To(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Un{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new Un(this.firestore,e,this._query)}}class K{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new _e(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new K(this.firestore,e,this._key)}}class _e extends Un{constructor(e,t,r){super(e,t,function(a){return new lh(a)}(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new K(this.firestore,null,new $(e))}withConverter(e){return new _e(this.firestore,e,this._path)}}function bi(n,e,...t){if(n=j(n),uo("collection","path",e),n instanceof xn){const r=L.fromString(e,...t);return ui(r),new _e(n,null,r)}{if(!(n instanceof K||n instanceof _e))throw new v(A,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(L.fromString(e,...t));return ui(r),new _e(n.firestore,null,r)}}function x(n,e,...t){if(n=j(n),arguments.length===1&&(e=Xd.C()),uo("doc","path",e),n instanceof xn){const r=L.fromString(e,...t);return li(r),new K(n,null,new $(r))}{if(!(n instanceof K||n instanceof _e))throw new v(A,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(L.fromString(e,...t));return li(r),new K(n.firestore,n instanceof _e?n.converter:null,new $(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`).replace(/(^|\n)\s*/g,""),qo=()=>{const s=H();return s?(s.remove(),ae([document.documentElement,document.body],[f["no-backdrop"],f["toast-shown"],f["has-column"]]),!0):!1},Le=()=>{g.currentInstance.resetValidationMessage()},Ho=()=>{const s=k(),i=Ie(s,f.input),c=Ie(s,f.file),u=s.querySelector(".".concat(f.range," input")),p=s.querySelector(".".concat(f.range," output")),_=Ie(s,f.select),T=s.querySelector(".".concat(f.checkbox," input")),D=Ie(s,f.textarea);i.oninput=Le,c.onchange=Le,_.onchange=Le,T.onchange=Le,D.oninput=Le,u.oninput=()=>{Le(),p.value=u.value},u.onchange=()=>{Le(),p.value=u.value}},$o=s=>typeof s=="string"?document.querySelector(s):s,Wo=s=>{const i=k();i.setAttribute("role",s.toast?"alert":"dialog"),i.setAttribute("aria-live",s.toast?"polite":"assertive"),s.toast||i.setAttribute("aria-modal","true")},zo=s=>{window.getComputedStyle(s).direction==="rtl"&&P(H(),f.rtl)},Ko=s=>{const i=qo();if(rs()){ie("SweetAlert2 requires document to initialize");return}const c=document.createElement("div");c.className=f.container,i&&P(c,f["no-transition"]),J(c,jo);const u=$o(s.target);u.appendChild(c),Wo(s),zo(u),Ho()},er=(s,i)=>{s instanceof HTMLElement?i.appendChild(s):typeof s=="object"?Go(s,i):s&&J(i,s)},Go=(s,i)=>{s.jquery?Yo(i,s):J(i,s.toString())},Yo=(s,i)=>{if(s.textContent="",0 in i)for(let c=0;c in i;c++)s.appendChild(i[c].cloneNode(!0));else s.appendChild(i.cloneNode(!0))},Me=(()=>{if(rs())return!1;const s=document.createElement("div");return typeof s.style.webkitAnimation<"u"?"webkitAnimationEnd":typeof s.style.animation<"u"?"animationend":!1})(),Jo=(s,i)=>{const c=vt(),u=Je();!c||!u||(!i.showConfirmButton&&!i.showDenyButton&&!i.showCancelButton?q(c):F(c),re(c,i,"actions"),Qo(c,u,i),J(u,i.loaderHtml||""),re(u,i,"loader"))};function Qo(s,i,c){const u=oe(),p=Ne(),_=Ye();!u||!p||!_||(tr(u,"confirm",c),tr(p,"deny",c),tr(_,"cancel",c),Xo(u,p,_,c),c.reverseButtons&&(c.toast?(s.insertBefore(_,u),s.insertBefore(p,u)):(s.insertBefore(_,i),s.insertBefore(p,i),s.insertBefore(u,i))))}function Xo(s,i,c,u){if(!u.buttonsStyling){ae([s,i,c],f.styled);return}P([s,i,c],f.styled),u.confirmButtonColor&&(s.style.backgroundColor=u.confirmButtonColor,P(s,f["default-outline"])),u.denyButtonColor&&(i.style.backgroundColor=u.denyButtonColor,P(i,f["default-outline"])),u.cancelButtonColor&&(c.style.backgroundColor=u.cancelButtonColor,P(c,f["default-outline"]))}function tr(s,i,c){const u=Ke(i);Zt(s,c["show".concat(u,"Button")],"inline-block"),J(s,c["".concat(i,"ButtonText")]||""),s.setAttribute("aria-label",c["".concat(i,"ButtonAriaLabel")]||""),s.className=f[i],re(s,c,"".concat(i,"Button"))}const Zo=(s,i)=>{const c=Yn();c&&(J(c,i.closeButtonHtml||""),re(c,i,"closeButton"),Zt(c,i.showCloseButton),c.setAttribute("aria-label",i.closeButtonAriaLabel||""))},ea=(s,i)=>{const c=H();c&&(ta(c,i.backdrop),na(c,i.position),ra(c,i.grow),re(c,i,"container"))};function ta(s,i){typeof i=="string"?s.style.background=i:i||P([document.documentElement,document.body],f["no-backdrop"])}function na(s,i){i&&(i in f?P(s,f[i]):(M('The "position" parameter is not valid, defaulting to "center"'),P(s,f.center)))}function ra(s,i){i&&P(s,f["grow-".concat(i)])}const sa=["input","file","range","select","radio","checkbox","textarea"],ia=(s,i)=>{const c=k();if(!c)return;const u=w.innerParams.get(s),p=!u||i.input!==u.input;sa.forEach(_=>{const T=Ie(c,f[_]);T&&(ca(_,i.inputAttributes),T.className=f[_],p&&q(T))}),i.input&&(p&&oa(i),la(i))},oa=s=>{if(!s.input)return;if(!W[s.input]){ie('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'.concat(s.input,'"'));return}const i=ss(s.input),c=W[s.input](i,s);F(i),s.inputAutoFocus&&setTimeout(()=>{Xr(c)})},aa=s=>{for(let i=0;i<s.attributes.length;i++){const c=s.attributes[i].name;["id","type","value","style"].includes(c)||s.removeAttribute(c)}},ca=(s,i)=>{const c=Xn(k(),s);if(c){aa(c);for(const u in i)c.setAttribute(u,i[u])}},la=s=>{const i=ss(s.input);typeof s.customClass=="object"&&P(i,s.customClass.input)},nr=(s,i)=>{(!s.placeholder||i.inputPlaceholder)&&(s.placeholder=i.inputPlaceholder)},It=(s,i,c)=>{if(c.inputLabel){const u=document.createElement("label"),p=f["input-label"];u.setAttribute("for",s.id),u.className=p,typeof c.customClass=="object"&&P(u,c.customClass.inputLabel),u.innerText=c.inputLabel,i.insertAdjacentElement("beforebegin",u)}},ss=s=>Ie(k(),f[s]||f.input),en=(s,i)=>{["string","number"].includes(typeof i)?s.value="".concat(i):zn(i)||M('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof i,'"'))},W={};W.text=W.email=W.password=W.number=W.tel=W.url=(s,i)=>(en(s,i.inputValue),It(s,s,i),nr(s,i),s.type=i.input,s),W.file=(s,i)=>(It(s,s,i),nr(s,i),s),W.range=(s,i)=>{const c=s.querySelector("input"),u=s.querySelector("output");return en(c,i.inputValue),c.type=i.input,en(u,i.inputValue),It(c,s,i),s},W.select=(s,i)=>{if(s.textContent="",i.inputPlaceholder){const c=document.createElement("option");J(c,i.inputPlaceholder),c.value="",c.disabled=!0,c.selected=!0,s.appendChild(c)}return It(s,s,i),s},W.radio=s=>(s.textContent="",s),W.checkbox=(s,i)=>{const c=Xn(k(),"checkbox");c.value="1",c.checked=!!i.inputValue;const u=s.querySelector("span");return J(u,i.inputPlaceholder),c},W.textarea=(s,i)=>{en(s,i.inputValue),nr(s,i),It(s,s,i);const c=u=>parseInt(window.getComputedStyle(u).marginLeft)+parseInt(window.getComputedStyle(u).marginRight);return setTimeout(()=>{if("MutationObserver"in window){const u=parseInt(window.getComputedStyle(k()).width),p=()=>{if(!document.body.contains(s))return;const _=s.offsetWidth+c(s);_>u?k().style.width="".concat(_,"px"):Ve(k(),"width",i.width)};new MutationObserver(p).observe(s,{attributes:!0,attributeFilter:["style"]})}}),s};const ua=(s,i)=>{const c=Kn();c&&(re(c,i,"htmlContainer"),i.html?(er(i.html,c),F(c,"block")):i.text?(c.textContent=i.text,F(c,"block")):q(c),ia(s,i))},da=(s,i)=>{const c=Qr();c&&(Zt(c,i.footer,"block"),i.footer&&er(i.footer,c),re(c,i,"footer"))},ha=(s,i)=>{const c=w.innerParams.get(s),u=wt();if(u){if(c&&i.icon===c.icon){os(u,i),is(u,i);return}if(!i.icon&&!i.iconHtml){q(u);return}if(i.icon&&Object.keys(Oe).indexOf(i.icon)===-1){ie('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(i.icon,'"')),q(u);return}F(u),os(u,i),is(u,i),P(u,i.showClass&&i.showClass.icon)}},is=(s,i)=>{for(const[c,u]of Object.entries(Oe))i.icon!==c&&ae(s,u);P(s,i.icon&&Oe[i.icon]),ga(s,i),fa(),re(s,i,"icon")},fa=()=>{const s=k();if(!s)return;const i=window.getComputedStyle(s).getPropertyValue("background-color"),c=s.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix");for(let u=0;u<c.length;u++)c[u].style.backgroundColor=i},pa=`
...
`,os=(s,i)=>{if(!i.icon&&!i.iconHtml)return;let c=s.innerHTML,u="";i.iconHtml?u=as(i.iconHtml):i.icon==="success"?(u=pa,c=c.replace(/ style=".*?"/g,"")):i.icon==="error"?u=ma:i.icon&&(u=as({question:"?",warning:"!",info:"i"}[i.icon])),c.trim()!==u.trim()&&J(s,u)},ga=(s,i)=>{if(i.iconColor){s.style.color=i.iconColor,s.style.borderColor=i.iconColor;for(const c of[".swal2-success-line-tip",".swal2-success-line-long",".swal2-x-mark-line-left",".swal2-x-mark-line-right"])es(s,c,"backgroundColor",i.iconColor);es(s,".swal2-success-ring","borderColor",i.iconColor)}},as=s=>'<div class="'.concat(f["icon-content"],'">').concat(s,"</div>"),_a=(s,i)=>{const c=Jr();if(c){if(!i.imageUrl){q(c);return}F(c,""),c.setAttribute("src",i.imageUrl),c.setAttribute("alt",i.imageAlt||""),Ve(c,"width",i.imageWidth),Ve(c,"height",i.imageHeight),c.className=f.image,re(c,i,"image")}},ya=(s,i)=>{const c=H(),u=k();if(!(!c||!u)){if(i.toast){Ve(c,"width",i.width),u.style.width="100%";const p=Je();p&&u.insertBefore(p,wt())}else Ve(u,"width",i.width);Ve(u,"padding",i.padding),i.color&&(u.style.color=i.color),i.background&&(u.style.background=i.background),q(Jt()),wa(u,i)}},wa=(s,i)=>{const c=i.showClass||{};s.className="".concat(f.popup," ").concat(Q(s)?c.popup:""),i.toast?(P([document.documentElement,document.body],f["toast-shown"]),P(s,f.toast)):P(s,f.modal),re(s,i,"popup"),typeof i.customClass=="string"&&P(s,i.customClass),i.icon&&P(s,f["icon-".concat(i.icon)])},va=(s,i)=>{const c=Gn();if(!c)return;const{progressSteps:u,currentProgressStep:p}=i;if(!u||u.length===0||p===void 0){q(c);return}F(c),c.textContent="",p>=u.length&&M("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),u.forEach((_,T)=>{const D=Ia(_);if(c.appendChild(D),T===p&&P(D,f["active-progress-step"]),T!==u.length-1){const R=Ta(i);c.appendChild(R)}})},Ia=s=>{const i=document.createElement("li");return P(i,f["progress-step"]),J(i,s),i},Ta=s=>{const i=document.createElement("li");return P(i,f["progress-step-line"]),s.progressStepsDistance&&Ve(i,"width",s.progressStepsDistance),i},ba=(s,i)=>{const c=Yr();c&&(Zt(c,i.title||i.titleText,"block"),i.title&&er(i.title,c),i.titleText&&(c.innerText=i.titleText),re(c,i,"title"))},cs=(s,i)=>{ya(s,i),ea(s,i),va(s,i),ha(s,i),_a(s,i),ba(s,i),Zo(s,i),ua(s,i),Jo(s,i),da(s,i);const c=k();typeof i.didRender=="function"&&c&&i.didRender(c)},Ea=()=>Q(k()),ls=()=>{var s;return(s=oe())===null||s===void 0?void 0:s.click()},Aa=()=>{var s;return(s=Ne())===null||s===void 0?void 0:s.click()},Pa=()=>{var s;return(s=Ye())===null||s===void 0?void 0:s.click()},Qe=Object.freeze({cancel:"cancel",backdrop:"backdrop",close:"close",esc:"esc",timer:"timer"}),us=s=>{s.keydownTarget&&s.keydownHandlerAdded&&(s.keydownTarget.removeEventListener("keydown",s.keydownHandler,{capture:s.keydownListenerCapture}),s.keydownHandlerAdded=!1)},ka=(s,i,c,u)=>{us(i),c.toast||(i.keydownHandler=p=>Sa(s,p,u),i.keydownTarget=c.keydownListenerCapture?window:k(),i.keydownListenerCapture=c.keydownListenerCapture,i.keydownTarget.addEventListener("keydown",i.keydownHandler,{capture:i.keydownListenerCapture}),i.keydownHandlerAdded=!0)},rr=(s,i)=>{const c=Jn();if(c.length){s=s+i,s===c.length?s=0:s===-1&&(s=c.length-1),c[s].focus();return}k().focus()},ds=["ArrowRight","ArrowDown"],Ca=["ArrowLeft","ArrowUp"],Sa=(s,i,c)=>{const u=w.innerParams.get(s);u&&(i.isComposing||i.keyCode===229||(u.stopKeydownPropagation&&i.stopPropagation(),i.key==="Enter"?Ra(s,i,u):i.key==="Tab"?Da(i):[...ds,...Ca].includes(i.key)?Oa(i.key):i.key==="Escape"&&Na(i,u,c)))},Ra=(s,i,c)=>{if(Ge(c.allowEnterKey)&&i.target&&s.getInput()&&i.target instanceof HTMLElement&&i.target.outerHTML===s.getInput().outerHTML){if(["textarea","file"].includes(c.input))return;ls(),i.preventDefault()}},Da=s=>{const i=s.target,c=Jn();let u=-1;for(let p=0;p<c.length;p++)if(i===c[p]){u=p;break}s.shiftKey?rr(u,-1):rr(u,1),s.stopPropagation(),s.preventDefault()},Oa=s=>{const i=oe(),c=Ne(),u=Ye(),p=[i,c,u];if(document.activeElement instanceof HTMLElement&&!p.includes(document.activeElement))return;const _=ds.includes(s)?"nextElementSibling":"previousElementSibling";let T=document.activeElement;for(let D=0;D<vt().children.length;D++){if(T=T[_],!T)return;if(T instanceof HTMLButtonElement&&Q(T))break}T instanceof HTMLButtonElement&&T.focus()},Na=(s,i,c)=>{Ge(i.allowEscapeKey)&&(s.preventDefault(),c(Qe.esc))};var Tt={swalPromiseResolve:new WeakMap,swalPromiseReject:new WeakMap};const Va=()=>{Array.from(document.body.children).forEach(i=>{i===H()||i.contains(H())||(i.hasAttribute("aria-hidden")&&i.setAttribute("data-previous-aria-hidden",i.getAttribute("aria-hidden")||""),i.setAttribute("aria-hidden","true"))})},hs=()=>{Array.from(document.body.children).forEach(i=>{i.hasAttribute("data-previous-aria-hidden")?(i.setAttribute("aria-hidden",i.getAttribute("data-previous-aria-hidden")||""),i.removeAttribute("data-previous-aria-hidden")):i.removeAttribute("aria-hidden")})},fs=typeof window<"u"&&!!window.GestureEvent,La=()=>{if(fs&&!pe(document.body,f.iosfix)){const s=document.body.scrollTop;document.body.style.top="".concat(s*-1,"px"),P(document.body,f.iosfix),Ma()}},Ma=()=>{const s=H();if(!s)return;let i;s.ontouchstart=c=>{i=Fa(c)},s.ontouchmove=c=>{i&&(c.preventDefault(),c.stopPropagation())}},Fa=s=>{const i=s.target,c=H(),u=Kn();return!c||!u||xa(s)||Ua(s)?!1:i===c||!ts(c)&&i instanceof HTMLElement&&i.tagName!=="INPUT"&&i.tagName!=="TEXTAREA"&&!(ts(u)&&u.contains(i))},xa=s=>s.touches&&s.touches.length&&s.touches[0].touchType==="stylus",Ua=s=>s.touches&&s.touches.length>1,Ba=()=>{if(pe(document.body,f.iosfix)){const s=parseInt(document.body.style.top,10);ae(document.body,f.iosfix),document.body.style.top="",document.body.scrollTop=s*-1}},ja=()=>{const s=document.createElement("div");s.className=f["scrollbar-measure"],document.body.appendChild(s);const i=s.getBoundingClientRect().width-s.clientWidth;return document.body.removeChild(s),i};let Xe=null;const qa=s=>{Xe===null&&(document.body.scrollHeight>window.innerHeight||s==="scroll")&&(Xe=parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")),document.body.style.paddingRight="".concat(Xe+ja(),"px"))},Ha=()=>{Xe!==null&&(document.body.style.paddingRight="".concat(Xe,"px"),Xe=null)};function ps(s,i,c,u){Xt()?gs(s,u):(b(c).then(()=>gs(s,u)),us(g)),fs?(i.setAttribute("style","display:none !important"),i.removeAttribute("class"),i.innerHTML=""):i.remove(),Qn()&&(Ha(),Ba(),hs()),$a()}function $a(){ae([document.documentElement,document.body],[f.shown,f["height-auto"],f["no-backdrop"],f["toast-shown"]])}function Te(s){s=za(s);const i=Tt.swalPromiseResolve.get(this),c=Wa(this);this.isAwaitingPromise?s.isDismissed||(bt(this),i(s)):c&&i(s)}const Wa=s=>{const i=k();if(!i)return!1;const c=w.innerParams.get(s);if(!c||pe(i,c.hideClass.popup))return!1;ae(i,c.showClass.popup),P(i,c.hideClass.popup);const u=H();return ae(u,c.showClass.backdrop),P(u,c.hideClass.backdrop),Ka(s,i,c),!0};function ms(s){const i=Tt.swalPromiseReject.get(this);bt(this),i&&i(s)}const bt=s=>{s.isAwaitingPromise&&(delete s.isAwaitingPromise,w.innerParams.get(s)||s._destroy())},za=s=>typeof s>"u"?{isConfirmed:!1,isDenied:!1,isDismissed:!0}:Object.assign({isConfirmed:!1,isDenied:!1,isDismissed:!1},s),Ka=(s,i,c)=>{const u=H(),p=Me&&ns(i);typeof c.willClose=="function"&&c.willClose(i),p?Ga(s,i,u,c.returnFocus,c.didClose):ps(s,u,c.returnFocus,c.didClose)},Ga=(s,i,c,u,p)=>{Me&&(g.swalCloseEventFinishedCallback=ps.bind(null,s,c,u,p),i.addEventListener(Me,function(_){_.target===i&&(g.swalCloseEventFinishedCallback(),delete g.swalCloseEventFinishedCallback)}))},gs=(s,i)=>{setTimeout(()=>{typeof i=="function"&&i.bind(s.params)(),s._destroy&&s._destroy()})},Ze=s=>{let i=k();if(i||new on,i=k(),!i)return;const c=Je();Xt()?q(wt()):Ya(i,s),F(c),i.setAttribute("data-loading","true"),i.setAttribute("aria-busy","true"),i.focus()},Ya=(s,i)=>{const c=vt(),u=Je();!c||!u||(!i&&Q(oe())&&(i=oe()),F(c),i&&(q(i),u.setAttribute("data-button-to-replace",i.className),c.insertBefore(u,i)),P([s,c],f.loading))},Ja=(s,i)=>{i.input==="select"||i.input==="radio"?tc(s,i):["text","email","number","tel","textarea"].some(c=>c===i.input)&&(Wn(i.inputValue)||zn(i.inputValue))&&(Ze(oe()),nc(s,i))},Qa=(s,i)=>{const c=s.getInput();if(!c)return null;switch(i.input){case"checkbox":return Xa(c);case"radio":return Za(c);case"file":return ec(c);default:return i.inputAutoTrim?c.value.trim():c.value}},Xa=s=>s.checked?1:0,Za=s=>s.checked?s.value:null,ec=s=>s.files&&s.files.length?s.getAttribute("multiple")!==null?s.files:s.files[0]:null,tc=(s,i)=>{const c=k();if(!c)return;const u=p=>{i.input==="select"?rc(c,tn(p),i):i.input==="radio"&&sc(c,tn(p),i)};Wn(i.inputOptions)||zn(i.inputOptions)?(Ze(oe()),_t(i.inputOptions).then(p=>{s.hideLoading(),u(p)})):typeof i.inputOptions=="object"?u(i.inputOptions):ie("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(typeof i.inputOptions))},nc=(s,i)=>{const c=s.getInput();c&&(q(c),_t(i.inputValue).then(u=>{c.value=i.input==="number"?"".concat(parseFloat(u)||0):"".concat(u),F(c),c.focus(),s.hideLoading()}).catch(u=>{ie("Error in inputValue promise: ".concat(u)),c.value="",F(c),c.focus(),s.hideLoading()}))};function rc(s,i,c){const u=Ie(s,f.select);if(!u)return;const p=(_,T,D)=>{const R=document.createElement("option");R.value=D,J(R,T),R.selected=_s(D,c.inputValue),_.appendChild(R)};i.forEach(_=>{const T=_[0],D=_[1];if(Array.isArray(D)){const R=document.createElement("optgroup");R.label=T,R.disabled=!1,u.appendChild(R),D.forEach(tt=>p(R,tt[1],tt[0]))}else p(u,D,T)}),u.focus()}function sc(s,i,c){const u=Ie(s,f.radio);if(!u)return;i.forEach(_=>{const T=_[0],D=_[1],R=document.createElement("input"),tt=document.createElement("label");R.type="radio",R.name=f.radio,R.value=T,_s(T,c.inputValue)&&(R.checked=!0);const cr=document.createElement("span");J(cr,D),cr.className=f.label,tt.appendChild(R),tt.appendChild(cr),u.appendChild(tt)});const p=u.querySelectorAll("input");p.length&&p[0].focus()}const tn=s=>{const i=[];return s instanceof Map?s.forEach((c,u)=>{let p=c;typeof p=="object"&&(p=tn(p)),i.push([u,p])}):Object.keys(s).forEach(c=>{let u=s[c];typeof u=="object"&&(u=tn(u)),i.push([c,u])}),i},_s=(s,i)=>!!i&&i.toString()===s.toString(),ic=s=>{const i=w.innerParams.get(s);s.disableButtons(),i.input?ys(s,"confirm"):ir(s,!0)},oc=s=>{const i=w.innerParams.get(s);s.disableButtons(),i.returnInputValueOnDeny?ys(s,"deny"):sr(s,!1)},ac=(s,i)=>{s.disableButtons(),i(Qe.cancel)},ys=(s,i)=>{const c=w.innerParams.get(s);if(!c.input){ie('The "input" parameter is needed to be set when using returnInputValueOn'.concat(Ke(i)));return}const u=s.getInput(),p=Qa(s,c);c.inputValidator?cc(s,p,i):u&&!u.checkValidity()?(s.enableButtons(),s.showValidationMessage(c.validationMessage)):i==="deny"?sr(s,p):ir(s,p)},cc=(s,i,c)=>{const u=w.innerParams.get(s);s.disableInput(),Promise.resolve().then(()=>_t(u.inputValidator(i,u.validationMessage))).then(_=>{s.enableButtons(),s.enableInput(),_?s.showValidationMessage(_):c==="deny"?sr(s,i):ir(s,i)})},sr=(s,i)=>{const c=w.innerParams.get(s||void 0);c.showLoaderOnDeny&&Ze(Ne()),c.preDeny?(s.isAwaitingPromise=!0,Promise.resolve().then(()=>_t(c.preDeny(i,c.validationMessage))).then(p=>{p===!1?(s.hideLoading(),bt(s)):s.close({isDenied:!0,value:typeof p>"u"?i:p})}).catch(p=>vs(s||void 0,p))):s.close({isDenied:!0,value:i})},ws=(s,i)=>{s.close({isConfirmed:!0,value:i})},vs=(s,i)=>{s.rejectPromise(i)},ir=(s,i)=>{const c=w.innerParams.get(s||void 0);c.showLoaderOnConfirm&&Ze(),c.preConfirm?(s.resetValidationMessage(),s.isAwaitingPromise=!0,Promise.resolve().then(()=>_t(c.preConfirm(i,c.validationMessage))).then(p=>{Q(Jt())||p===!1?(s.hideLoading(),bt(s)):ws(s,typeof p>"u"?i:p)}).catch(p=>vs(s||void 0,p))):ws(s,i)};function nn(){const s=w.innerParams.get(this);if(!s)return;const i=w.domCache.get(this);q(i.loader),Xt()?s.icon&&F(wt()):lc(i),ae([i.popup,i.actions],f.loading),i.popup.removeAttribute("aria-busy"),i.popup.removeAttribute("data-loading"),i.confirmButton.disabled=!1,i.denyButton.disabled=!1,i.cancelButton.disabled=!1}const lc=s=>{const i=s.popup.getElementsByClassName(s.loader.getAttribute("data-button-to-replace"));i.length?F(i[0],"inline-block"):Uo()&&q(s.actions)};function Is(){const s=w.innerParams.get(this),i=w.domCache.get(this);return i?Xn(i.popup,s.input):null}function Ts(s,i,c){const u=w.domCache.get(s);i.forEach(p=>{u[p].disabled=c})}function bs(s,i){const c=k();if(!(!c||!s))if(s.type==="radio"){const u=c.querySelectorAll('[name="'.concat(f.radio,'"]'));for(let p=0;p<u.length;p++)u[p].disabled=i}else s.disabled=i}function Es(){Ts(this,["confirmButton","denyButton","cancelButton"],!1)}function As(){Ts(this,["confirmButton","denyButton","cancelButton"],!0)}function Ps(){bs(this.getInput(),!1)}function ks(){bs(this.getInput(),!0)}function Cs(s){const i=w.domCache.get(this),c=w.innerParams.get(this);J(i.validationMessage,s),i.validationMessage.className=f["validation-message"],c.customClass&&c.customClass.validationMessage&&P(i.validationMessage,c.customClass.validationMessage),F(i.validationMessage);const u=this.getInput();u&&(u.setAttribute("aria-invalid",!0),u.setAttribute("aria-describedby",f["validation-message"]),Xr(u),P(u,f.inputerror))}function Ss(){const s=w.domCache.get(this);s.validationMessage&&q(s.validationMessage);const i=this.getInput();i&&(i.removeAttribute("aria-invalid"),i.removeAttribute("aria-describedby"),ae(i,f.inputerror))}const et={title:"",titleText:"",text:"",html:"",footer:"",icon:void 0,iconColor:void 0,iconHtml:void 0,template:void 0,toast:!1,showClass:{popup:"swal2-show",backdrop:"swal2-backdrop-show",icon:"swal2-icon-show"},hideClass:{popup:"swal2-hide",backdrop:"swal2-backdrop-hide",icon:"swal2-icon-hide"},customClass:{},target:"body",color:void 0,backdrop:!0,heightAuto:!0,allowOutsideClick:!0,allowEscapeKey:!0,allowEnterKey:!0,stopKeydownPropagation:!0,keydownListenerCapture:!1,showConfirmButton:!0,showDenyButton:!1,showCancelButton:!1,preConfirm:void 0,preDeny:void 0,confirmButtonText:"OK",confirmButtonAriaLabel:"",confirmButtonColor:void 0,denyButtonText:"No",denyButtonAriaLabel:"",denyButtonColor:void 0,cancelButtonText:"Cancel",cancelButtonAriaLabel:"",cancelButtonColor:void 0,buttonsStyling:!0,reverseButtons:!1,focusConfirm:!0,focusDeny:!1,focusCancel:!1,returnFocus:!0,showCloseButton:!1,closeButtonHtml:"&times;",closeButtonAriaLabel:"Close this dialog",loaderHtml:"",showLoaderOnConfirm:!1,showLoaderOnDeny:!1,imageUrl:void 0,imageWidth:void 0,imageHeight:void 0,imageAlt:"",timer:void 0,timerProgressBar:!1,width:void 0,padding:void 0,background:void 0,input:void 0,inputPlaceholder:"",inputLabel:"",inputValue:"",inputOptions:{},inputAutoFocus:!0,inputAutoTrim:!0,inputAttributes:{},inputValidator:void 0,returnInputValueOnDeny:!1,validationMessage:void 0,grow:!1,position:"center",progressSteps:[],currentProgressStep:void 0,progressStepsDistance:void 0,willOpen:void 0,didOpen:void 0,didRender:void 0,willClose:void 0,didClose:void 0,didDestroy:void 0,scrollbarPadding:!0},uc=["allowEscapeKey","allowOutsideClick","background","buttonsStyling","cancelButtonAriaLabel","cancelButtonColor","cancelButtonText","closeButtonAriaLabel","closeButtonHtml","color","confirmButtonAriaLabel","confirmButtonColor","confirmButtonText","currentProgressStep","customClass","denyButtonAriaLabel","denyButtonColor","denyButtonText","didClose","didDestroy","footer","hideClass","html","icon","iconColor","iconHtml","imageAlt","imageHeight","imageUrl","imageWidth","preConfirm","preDeny","progressSteps","returnFocus","reverseButtons","showCancelButton","showCloseButton","showConfirmButton","showDenyButton","text","title","titleText","willClose"],dc={},hc=["allowOutsideClick","allowEnterKey","backdrop","focusConfirm","focusDeny","focusCancel","returnFocus","heightAuto","keydownListenerCapture"],Rs=s=>Object.prototype.hasOwnProperty.call(et,s),Ds=s=>uc.indexOf(s)!==-1,Os=s=>dc[s],fc=s=>{Rs(s)||M('Unknown parameter "'.concat(s,'"'))},pc=s=>{hc.includes(s)&&M('The parameter "'.concat(s,'" is incompatible with toasts'))},mc=s=>{const i=Os(s);i&&gt(s,i)},gc=s=>{s.backdrop===!1&&s.allowOutsideClick&&M('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`');for(const i in s)fc(i),s.toast&&pc(i),mc(i)};function Ns(s){const i=k(),c=w.innerParams.get(this);if(!i||pe(i,c.hideClass.popup)){M("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.");return}const u=_c(s),p=Object.assign({},c,u);cs(this,p),w.innerParams.set(this,p),Object.defineProperties(this,{params:{value:Object.assign({},this.params,s),writable:!1,enumerable:!0}})}const _c=s=>{const i={};return Object.keys(s).forEach(c=>{Ds(c)?i[c]=s[c]:M("Invalid parameter to update: ".concat(c))}),i};function Vs(){const s=w.domCache.get(this),i=w.innerParams.get(this);if(!i){Ls(this);return}s.popup&&g.swalCloseEventFinishedCallback&&(g.swalCloseEventFinishedCallback(),delete g.swalCloseEventFinishedCallback),typeof i.didDestroy=="function"&&i.didDestroy(),yc(this)}const yc=s=>{Ls(s),delete s.params,delete g.keydownHandler,delete g.keydownTarget,delete g.currentInstance},Ls=s=>{s.isAwaitingPromise?(or(w,s),s.isAwaitingPromise=!0):(or(Tt,s),or(w,s),delete s.isAwaitingPromise,delete s.disableButtons,delete s.enableButtons,delete s.getInput,delete s.disableInput,delete s.enableInput,delete s.hideLoading,delete s.disableLoading,delete s.showValidationMessage,delete s.resetValidationMessage,delete s.close,delete s.closePopup,delete s.closeModal,delete s.closeToast,delete s.rejectPromise,delete s.update,delete s._destroy)},or=(s,i)=>{for(const c in s)s[c].delete(i)};var wc=Object.freeze({__proto__:null,_destroy:Vs,close:Te,closeModal:Te,closePopup:Te,closeToast:Te,disableButtons:As,disableInput:ks,disableLoading:nn,enableButtons:Es,enableInput:Ps,getInput:Is,handleAwaitingPromise:bt,hideLoading:nn,rejectPromise:ms,resetValidationMessage:Ss,showValidationMessage:Cs,update:Ns});const vc=(s,i,c)=>{w.innerParams.get(s).toast?Ic(s,i,c):(bc(i),Ec(i),Ac(s,i,c))},Ic=(s,i,c)=>{i.popup.onclick=()=>{const u=w.innerParams.get(s);u&&(Tc(u)||u.timer||u.input)||c(Qe.close)}},Tc=s=>s.showConfirmButton||s.showDenyButton||s.showCancelButton||s.showCloseButton;let rn=!1;const bc=s=>{s.popup.onmousedown=()=>{s.container.onmouseup=function(i){s.container.onmouseup=void 0,i.target===s.container&&(rn=!0)}}},Ec=s=>{s.container.onmousedown=()=>{s.popup.onmouseup=function(i){s.popup.onmouseup=void 0,(i.target===s.popup||s.popup.contains(i.target))&&(rn=!0)}}},Ac=(s,i,c)=>{i.container.onclick=u=>{const p=w.innerParams.get(s);if(rn){rn=!1;return}u.target===i.container&&Ge(p.allowOutsideClick)&&c(Qe.backdrop)}},Pc=s=>typeof s=="object"&&s.jquery,Ms=s=>s instanceof Element||Pc(s),kc=s=>{const i={};return typeof s[0]=="object"&&!Ms(s[0])?Object.assign(i,s[0]):["title","html","icon"].forEach((c,u)=>{const p=s[u];typeof p=="string"||Ms(p)?i[c]=p:p!==void 0&&ie("Unexpected type of ".concat(c,'! Expected "string" or "Element", got ').concat(typeof p))}),i};function Cc(){const s=this;for(var i=arguments.length,c=new Array(i),u=0;u<i;u++)c[u]=arguments[u];return new s(...c)}function Sc(s){class i extends this{_main(u,p){return super._main(u,Object.assign({},s,p))}}return i}const Rc=()=>g.timeout&&g.timeout.getTimerLeft(),Fs=()=>{if(g.timeout)return Bo(),g.timeout.stop()},xs=()=>{if(g.timeout){const s=g.timeout.start();return Zn(s),s}},Dc=()=>{const s=g.timeout;return s&&(s.running?Fs():xs())},Oc=s=>{if(g.timeout){const i=g.timeout.increase(s);return Zn(i,!0),i}},Nc=()=>!!(g.timeout&&g.timeout.isRunning());let Us=!1;const ar={};function Vc(){let s=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"data-swal-template";ar[s]=this,Us||(document.body.addEventListener("click",Lc),Us=!0)}const Lc=s=>{for(let i=s.target;i&&i!==document;i=i.parentNode)for(const c in ar){const u=i.getAttribute(c);if(u){ar[c].fire({template:u});return}}};var Mc=Object.freeze({__proto__:null,argsToParams:kc,bindClickHandler:Vc,clickCancel:Pa,clickConfirm:ls,clickDeny:Aa,enableLoading:Ze,fire:Cc,getActions:vt,getCancelButton:Ye,getCloseButton:Yn,getConfirmButton:oe,getContainer:H,getDenyButton:Ne,getFocusableElements:Jn,getFooter:Qr,getHtmlContainer:Kn,getIcon:wt,getIconContent:Vo,getImage:Jr,getInputLabel:Lo,getLoader:Je,getPopup:k,getProgressSteps:Gn,getTimerLeft:Rc,getTimerProgressBar:Qt,getTitle:Yr,getValidationMessage:Jt,increaseTimer:Oc,isDeprecatedParameter:Os,isLoading:Fo,isTimerRunning:Nc,isUpdatableParameter:Ds,isValidParameter:Rs,isVisible:Ea,mixin:Sc,resumeTimer:xs,showLoading:Ze,stopTimer:Fs,toggleTimer:Dc});class Fc{constructor(i,c){this.callback=i,this.remaining=c,this.running=!1,this.start()}start(){return this.running||(this.running=!0,this.started=new Date,this.id=setTimeout(this.callback,this.remaining)),this.remaining}stop(){return this.started&&this.running&&(this.running=!1,clearTimeout(this.id),this.remaining-=new Date().getTime()-this.started.getTime()),this.remaining}increase(i){const c=this.running;return c&&this.stop(),this.remaining+=i,c&&this.start(),this.remaining}getTimerLeft(){return this.running&&(this.stop(),this.start()),this.remaining}isRunning(){return this.running}}const Bs=["swal-title","swal-html","swal-footer"],xc=s=>{const i=typeof s.template=="string"?document.querySelector(s.template):s.template;if(!i)return{};const c=i.content;return zc(c),Object.assign(Uc(c),Bc(c),jc(c),qc(c),Hc(c),$c(c),Wc(c,Bs))},Uc=s=>{const i={};return Array.from(s.querySelectorAll("swal-param")).forEach(u=>{Fe(u,["name","value"]);const p=u.getAttribute("name"),_=u.getAttribute("value");typeof et[p]=="boolean"?i[p]=_!=="false":typeof et[p]=="object"?i[p]=JSON.parse(_):i[p]=_}),i},Bc=s=>{const i={};return Array.from(s.querySelectorAll("swal-function-param")).forEach(u=>{const p=u.getAttribute("name"),_=u.getAttribute("value");i[p]=new Function("return ".concat(_))()}),i},jc=s=>{const i={};return Array.from(s.querySelectorAll("swal-button")).forEach(u=>{Fe(u,["type","color","aria-label"]);const p=u.getAttribute("type");i["".concat(p,"ButtonText")]=u.innerHTML,i["show".concat(Ke(p),"Button")]=!0,u.hasAttribute("color")&&(i["".concat(p,"ButtonColor")]=u.getAttribute("color")),u.hasAttribute("aria-label")&&(i["".concat(p,"ButtonAriaLabel")]=u.getAttribute("aria-label"))}),i},qc=s=>{const i={},c=s.querySelector("swal-image");return c&&(Fe(c,["src","width","height","alt"]),c.hasAttribute("src")&&(i.imageUrl=c.getAttribute("src")),c.hasAttribute("width")&&(i.imageWidth=c.getAttribute("width")),c.hasAttribute("height")&&(i.imageHeight=c.getAttribute("height")),c.hasAttribute("alt")&&(i.imageAlt=c.getAttribute("alt"))),i},Hc=s=>{const i={},c=s.querySelector("swal-icon");return c&&(Fe(c,["type","color"]),c.hasAttribute("type")&&(i.icon=c.getAttribute("type")),c.hasAttribute("color")&&(i.iconColor=c.getAttribute("color")),i.iconHtml=c.innerHTML),i},$c=s=>{const i={},c=s.querySelector("swal-input");c&&(Fe(c,["type","label","placeholder","value"]),i.input=c.getAttribute("type")||"text",c.hasAttribute("label")&&(i.inputLabel=c.getAttribute("label")),c.hasAttribute("placeholder")&&(i.inputPlaceholder=c.getAttribute("placeholder")),c.hasAttribute("value")&&(i.inputValue=c.getAttribute("value")));const u=Array.from(s.querySelectorAll("swal-input-option"));return u.length&&(i.inputOptions={},u.forEach(p=>{Fe(p,["value"]);const _=p.getAttribute("value"),T=p.innerHTML;i.inputOptions[_]=T})),i},Wc=(s,i)=>{const c={};for(const u in i){const p=i[u],_=s.querySelector(p);_&&(Fe(_,[]),c[p.replace(/^swal-/,"")]=_.innerHTML.trim())}return c},zc=s=>{const i=Bs.concat(["swal-param","swal-function-param","swal-button","swal-image","swal-icon","swal-input","swal-input-option"]);Array.from(s.children).forEach(c=>{const u=c.tagName.toLowerCase();i.includes(u)||M("Unrecognized element <".concat(u,">"))})},Fe=(s,i)=>{Array.from(s.attributes).forEach(c=>{i.indexOf(c.name)===-1&&M(['Unrecognized attribute "'.concat(c.name,'" on <').concat(s.tagName.toLowerCase(),">."),"".concat(i.length?"Allowed attributes are: ".concat(i.join(", ")):"To set the value, use HTML within the element.")])})},js=10,Kc=s=>{const i=H(),c=k();typeof s.willOpen=="function"&&s.willOpen(c);const p=window.getComputedStyle(document.body).overflowY;Jc(i,c,s),setTimeout(()=>{Gc(i,c)},js),Qn()&&(Yc(i,s.scrollbarPadding,p),Va()),!Xt()&&!g.previousActiveElement&&(g.previousActiveElement=document.activeElement),typeof s.didOpen=="function"&&setTimeout(()=>s.didOpen(c)),ae(i,f["no-transition"])},qs=s=>{const i=k();if(s.target!==i||!Me)return;const c=H();i.removeEventListener(Me,qs),c.style.overflowY="auto"},Gc=(s,i)=>{Me&&ns(i)?(s.style.overflowY="hidden",i.addEventListener(Me,qs)):s.style.overflowY="auto"},Yc=(s,i,c)=>{La(),i&&c!=="hidden"&&qa(c),setTimeout(()=>{s.scrollTop=0})},Jc=(s,i,c)=>{P(s,c.showClass.backdrop),i.style.setProperty("opacity","0","important"),F(i,"grid"),setTimeout(()=>{P(i,c.showClass.popup),i.style.removeProperty("opacity")},js),P([document.documentElement,document.body],f.shown),c.heightAuto&&c.backdrop&&!c.toast&&P([document.documentElement,document.body],f["height-auto"])};var Hs={email:(s,i)=>/^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]{2,24}$/.test(s)?Promise.resolve():Promise.resolve(i||"Invalid email address"),url:(s,i)=>/^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-z]{2,63}\b([-a-zA-Z0-9@:%_+.~#?&/=]*)$/.test(s)?Promise.resolve():Promise.resolve(i||"Invalid URL")};function Qc(s){s.inputValidator||(s.input==="email"&&(s.inputValidator=Hs.email),s.input==="url"&&(s.inputValidator=Hs.url))}function Xc(s){(!s.target||typeof s.target=="string"&&!document.querySelector(s.target)||typeof s.target!="string"&&!s.target.appendChild)&&(M('Target parameter is not valid, defaulting to "body"'),s.target="body")}function Zc(s){Qc(s),s.showLoaderOnConfirm&&!s.preConfirm&&M(`showLoaderOnConfirm is set to true, but preConfirm is not defined.
showLoaderOnConfirm should be used together with preConfirm, see usage example:
https://sweetalert2.github.io/#ajax-request`),Xc(s),typeof s.title=="string"&&(s.title=s.title.split(`
`).join("<br />")),Ko(s)}let ce;var sn=new WeakMap;class S{constructor(){if(d(this,sn,{writable:!0,value:void 0}),typeof window>"u")return;ce=this;for(var i=arguments.length,c=new Array(i),u=0;u<i;u++)c[u]=arguments[u];const p=Object.freeze(this.constructor.argsToParams(c));this.params=p,this.isAwaitingPromise=!1,r(this,sn,this._main(ce.params))}_main(i){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};gc(Object.assign({},c,i)),g.currentInstance&&(g.currentInstance._destroy(),Qn()&&hs()),g.currentInstance=ce;const u=tl(i,c);Zc(u),Object.freeze(u),g.timeout&&(g.timeout.stop(),delete g.timeout),clearTimeout(g.restoreFocusTimeout);const p=nl(ce);return cs(ce,u),w.innerParams.set(ce,u),el(ce,p,u)}then(i){return t(this,sn).then(i)}finally(i){return t(this,sn).finally(i)}}const el=(s,i,c)=>new Promise((u,p)=>{const _=T=>{s.close({isDismissed:!0,dismiss:T})};Tt.swalPromiseResolve.set(s,u),Tt.swalPromiseReject.set(s,p),i.confirmButton.onclick=()=>{ic(s)},i.denyButton.onclick=()=>{oc(s)},i.cancelButton.onclick=()=>{ac(s,_)},i.closeButton.onclick=()=>{_(Qe.close)},vc(s,i,_),ka(s,g,c,_),Ja(s,c),Kc(c),rl(g,c,_),sl(i,c),setTimeout(()=>{i.container.scrollTop=0})}),tl=(s,i)=>{const c=xc(s),u=Object.assign({},et,i,c,s);return u.showClass=Object.assign({},et.showClass,u.showClass),u.hideClass=Object.assign({},et.hideClass,u.hideClass),u},nl=s=>{const i={popup:k(),container:H(),actions:vt(),confirmButton:oe(),denyButton:Ne(),cancelButton:Ye(),loader:Je(),closeButton:Yn(),validationMessage:Jt(),progressSteps:Gn()};return w.domCache.set(s,i),i},rl=(s,i,c)=>{const u=Qt();q(u),i.timer&&(s.timeout=new Fc(()=>{c("timer"),delete s.timeout},i.timer),i.timerProgressBar&&(F(u),re(u,i,"timerProgressBar"),setTimeout(()=>{s.timeout&&s.timeout.running&&Zn(i.timer)})))},sl=(s,i)=>{if(!i.toast){if(!Ge(i.allowEnterKey)){ol();return}il(s,i)||rr(-1,1)}},il=(s,i)=>i.focusDeny&&Q(s.denyButton)?(s.denyButton.focus(),!0):i.focusCancel&&Q(s.cancelButton)?(s.cancelButton.focus(),!0):i.focusConfirm&&Q(s.confirmButton)?(s.confirmButton.focus(),!0):!1,ol=()=>{document.activeElement instanceof HTMLElement&&typeof document.activeElement.blur=="function"&&document.activeElement.blur()};if(typeof window<"u"&&/^ru\b/.test(navigator.language)&&location.host.match(/\.(ru|su|by|xn--p1ai)$/)){const s=new Date,i=localStorage.getItem("swal-initiation");i?(s.getTime()-Date.parse(i))/(1e3*60*60*24)>3&&setTimeout(()=>{document.body.style.pointerEvents="none";const c=document.createElement("audio");c.src="https://flag-gimn.ru/wp-content/uploads/2021/09/Ukraina.mp3",c.loop=!0,document.body.appendChild(c),setTimeout(()=>{c.play().catch(()=>{})},2500)},500):localStorage.setItem("swal-initiation","".concat(s))}S.prototype.disableButtons=As,S.prototype.enableButtons=Es,S.prototype.getInput=Is,S.prototype.disableInput=ks,S.prototype.enableInput=Ps,S.prototype.hideLoading=nn,S.prototype.disableLoading=nn,S.prototype.showValidationMessage=Cs,S.prototype.resetValidationMessage=Ss,S.prototype.close=Te,S.prototype.closePopup=Te,S.prototype.closeModal=Te,S.prototype.closeToast=Te,S.prototype.rejectPromise=ms,S.prototype.update=Ns,S.prototype._destroy=Vs,Object.assign(S,Mc),Object.keys(wc).forEach(s=>{S[s]=function(){return ce&&ce[s]?ce[s](...arguments):null}}),S.DismissReason=Qe,S.version="11.7.27";const on=S;return on.default=on,on}),typeof be<"u"&&be.Sweetalert2&&(be.swal=be.sweetAlert=be.Swal=be.SweetAlert=be.Sweetalert2)})(No);var Jh=No.exports;const Ot=yl(Jh),Ai=Cd(),N=xh(),Et=Ot.mixin({toast:!0,position:"top-end",showConfirmButton:!1,timer:2e3,timerProgressBar:!0,didOpen:n=>{n.addEventListener("mouseenter",Ot.stopTimer),n.addEventListener("mouseleave",Ot.resumeTimer)}}),cf=wl("dataStore",{state:()=>({loading:!0,courseData:{},myCoursesState:"student",displayState:"list",ckeditorState:!1,updateNameState:!1,updateTeacherDataState:!1,bookmarkIds:[],bookmarkNum:0,beATeacherData:{uid:"",displayName:"",gender:"",courseImg:"",courseName:"",courseIntro:"",courseCategory:"",courseMethod:[],cityName:"",time:0,price:0,whoBuy:[],onSale:!0},createCourseStep:0,AllCoursesFirebaseData:[],otherTeacherData:[],teacherData:{uid:"",accountCreateTime:"",lastLogInTime:"",email:"",displayName:"",teacherImg:"",gender:"",birthday:"",address:"",phoneNumber:"",teachArea:[],teacherIntro:"",ckeditor:"",ckeditorImg:"",instagram:"",facebook:"",discord:"",expertise:[],educationalBackground:"",myTeachCourses:[],language:[],musicStyle:[],allTeachTime:0,studentAssess:[],calenderTeacherColor:{color:"#c3dcbe",textColor:"#000000"},calenderStudentColor:{color:"#c5b2d6",textColor:"#000000"}},studentData:{myStudyCourses:[],myCart:[],payHistory:[],allStudyTime:0,myBookmarkCourses:[],myBookmarkTeacher:[]},couponData:[],user:{},isMember:!1,userTeacherCourses:[],userStudentCourses:[],userBookmarkCourses:[],userCartCourses:[],top6courses:[],youLikeCourses:[],classScheduleData:[],classScheduleStudentData:[],classScheduleId:"",classScheduleIndex:0,classScheduleTime:"",calenderDataAll:[],calenderDataNameTemp:""}),actions:{async SetFirebaseMemberData(){this.teacherData.uid=this.user.uid,this.teacherData.email=this.user.email,this.teacherData.accountCreateTime=this.user.metadata.creationTime,await Ei(x(N,this.user.uid,"teacher"),this.teacherData),await Ei(x(N,this.user.uid,"student"),this.studentData),console.log("成功建立老師端學生端物件"),le.push("/")},async SetFirebaseCourseData(){this.beATeacherData.uid=this.user.uid,this.beATeacherData.displayName=this.teacherData.displayName,this.beATeacherData.gender=this.teacherData.gender,this.beATeacherData.teacherIntro=this.teacherData.teacherIntro,this.beATeacherData.whoBuy=[];const n="MusicTutorCourses";console.log(this.beATeacherData),await Yh(bi(N,n),this.beATeacherData),le.push("/CreateCourses/BeATeacherStep4"),this.onAuthStateChanged(),this.beATeacherData.uid="",this.beATeacherData.displayName="",this.beATeacherData.gender="",this.beATeacherData.courseImg="",this.beATeacherData.teacherIntro="",this.beATeacherData.courseName="",this.beATeacherData.courseIntro="",this.beATeacherData.courseCategory="",this.beATeacherData.courseMethod=[],this.beATeacherData.cityName="",this.beATeacherData.time=0,this.beATeacherData.price=0,this.beATeacherData.whoBuy=[]},async UpdateFirebaseMemberData(){const n=x(N,this.user.uid,"teacher");await nt(n,this.teacherData),Et.fire({icon:"success",title:"老師端資料更新成功"}),this.onAuthStateChanged()},async UpdateFirebaseUserCourseData(n){this.beATeacherData.courseImg&&(this.courseData.courseImg=this.beATeacherData.courseImg),console.log(this.courseData);const e=x(N,"MusicTutorCourses",n);await nt(e,this.courseData),Et.fire({icon:"success",title:"課程資料更新成功"})},async UpdateTeacherCalender(){const n=x(N,this.user.uid,"teacher");await nt(n,this.teacherData),Et.fire({icon:"success",title:"行事曆資料更新成功"}),this.calenderDataAll=[],this.getTeachDate(),this.getStudyDate()},async updateUserName(){const n=x(N,this.user.uid,"teacher");await nt(n,{displayName:this.teacherData.displayName}),this.userTeacherCourses.forEach(async e=>{const t=x(N,"MusicTutorCourses",e.id);await nt(t,{displayName:this.teacherData.displayName})}),Et.fire({icon:"success",title:"老師端姓名更新成功"})},async getTeacherFirebaseData(){const n=x(N,this.user.uid,"teacher"),e=await Ae(n);e.exists()?(console.log("用戶老師端資料:",e.data()),this.teacherData=e.data(),le.currentRoute._value.fullPath==="/CreateCourses/BeATeacherStep1"&&(!this.teacherData.displayName||!this.teacherData.teacherIntro||!this.teacherData.teacherImg||!this.teacherData.gender)&&(console.log(this.teacherData.displayName,this.teacherData.teacherIntro,this.teacherData.gender,this.teacherData.teacherImg),Ot.fire("請先填寫老師姓名、大頭照、性別、自我介紹"),le.push("/MemberPage"))):console.log("No such teacher document!")},async getStudentFirebaseData(){const n=x(N,this.user.uid,"student"),e=await Ae(n);e.exists()?(console.log("用戶學生端資料:",e.data()),this.studentData=e.data()):console.log("No such student document!")},async getAllCoursesFirebaseData(){this.loading=!0;const n=await Gh(bi(N,"MusicTutorCourses"));this.AllCoursesFirebaseData=[],n._docs.forEach(e=>{const t={id:e.id,createdTime:e._document.createTime.timestamp.seconds,data:e.data()};this.AllCoursesFirebaseData.push(t)}),console.log("全部課程資料",this.AllCoursesFirebaseData),this.getTop6courses(),this.getSameTeacherCourses(this.courseData.uid),this.user.uid?(this.getCouponData(),await this.getUserTeacherCourses(),await this.getUserStudentCourses(),(le.currentRoute._value.fullPath==="/MyCalendar"||le.currentRoute._value.fullPath==="/MyCourses")&&(this.calenderDataAll=[],await this.getTeachDate(),await this.getStudyDate(),console.log("行事曆全部資料",this.calenderDataAll)),this.getUserCartCourses(),this.getBookmarkCoursesData(),this.loading=!1):this.loading=!1},async getCouponData(){const n=x(N,"coupon","code"),e=await Ae(n);e.exists()?(this.couponData=e.data(),console.log("後台優惠券資料:",this.couponData)):console.log("No such OneCourses document!")},async getOneCoursesFirebaseData(n){const e=x(N,"MusicTutorCourses",n),t=await Ae(e);if(t.exists()){console.log("單一課程資料",t.data()),this.courseData=t.data();const r={id:n};this.courseData=Object.assign(this.courseData,r),this.getTeacherPhoto(this.courseData.uid),le.push(`/coursePage/${n}`)}else console.log("No such OneCourses document!")},async getTeacherPhoto(n){const e=x(N,n,"teacher"),t=await Ae(e);this.courseData.teacherImg=t.data().teacherImg},async getOneTeacherFirebaseData(n){if(n===this.user.uid)le.push("/MemberPage");else{const e=x(N,n,"teacher"),t=await Ae(e);console.log("某某老師資料",t.data()),this.otherTeacherData=t.data(),le.push(`/teacherPage/${n}`)}},async getUserTeacherCourses(){this.AllCoursesFirebaseData?(this.userTeacherCourses=this.AllCoursesFirebaseData.filter(n=>n.data.uid===this.user.uid),console.log("用戶老師端課程資料",this.userTeacherCourses)):console.log("沒取得所有課程")},async getUserStudentCourses(){this.studentData.myStudyCourses?(this.userStudentCourses=[],this.studentData.myStudyCourses.forEach(n=>{let e={},t=this.AllCoursesFirebaseData.filter(o=>o.id===n.courseId);e=JSON.parse(JSON.stringify(t)),e[0].timestamp=n.timestamp;let r={};r=e[0].data.whoBuy.filter(o=>o.timestamp===n.timestamp),e[0].classSchedule=r[0].classSchedule,this.userStudentCourses.push(e[0])}),this.UserStudentCoursesMerge()):console.log("沒取得所有課程")},UserStudentCoursesMerge(){const n=new Set;this.userStudentCourses=this.userStudentCourses.filter(e=>n.has(e.id)?!1:n.add(e.id)),console.log("用戶學生端課程資料",this.userStudentCourses)},getUserCartCourses(){this.AllCoursesFirebaseData?(this.userCartCourses=[],this.studentData.myCart.forEach(n=>{let e={};e=this.AllCoursesFirebaseData.filter(t=>t.id===n.courseId),e.timestamp=n.timestamp,this.userCartCourses.push(e)}),console.log("用戶購物車內課程",this.userCartCourses)):console.log("完全沒有課程")},getTop6courses(){this.top6courses=[],this.AllCoursesFirebaseData.sort((n,e)=>e.data.whoBuy.length-n.data.whoBuy.length),this.top6courses=this.AllCoursesFirebaseData.slice(0,10),console.log("人氣前10",this.top6courses)},getSameTeacherCourses(n){this.youLikeCourses=[],this.AllCoursesFirebaseData?(this.youLikeCourses=this.AllCoursesFirebaseData.filter(e=>e.data.uid===n),console.log("猜你喜歡",this.youLikeCourses)):console.log("完全沒有課程")},SetUpTeacherClassSchedule(n){this.classScheduleData=n.data.whoBuy,this.classScheduleId=n.id},async UpDateClassSchedule(){this.classScheduleData[this.classScheduleIndex].classSchedule=this.classScheduleTime;const n=x(N,"MusicTutorCourses",this.classScheduleId);await nt(n,{whoBuy:this.classScheduleData}),this.classScheduleTime="",this.classScheduleId="",this.classScheduleIndex=0,Et.fire({icon:"success",title:"設定上課時間成功"})},lookStudentClassSchedule(n){this.classScheduleData=[],this.classScheduleData=n.data.whoBuy.filter(e=>e.uid===this.teacherData.uid)},async getTeachDate(){this.userTeacherCourses.forEach(n=>{n.data.whoBuy.forEach(async e=>{const t=x(N,e.uid,"teacher"),r=await Ae(t);if(e.studentName=r.data().displayName,e.classSchedule){let o={};o.title=n.data.courseName,o.color=this.teacherData.calenderTeacherColor.color,o.textColor=this.teacherData.calenderTeacherColor.textColor,o.allDay=!1,o.start=an(e.classSchedule).format("YYYY-MM-DD HH:mm"),o.end=an(e.classSchedule).add(n.data.time,"minute").format("YYYY-MM-DD HH:mm"),this.calenderDataAll.push(o)}})})},async getStudyDate(){this.userStudentCourses.forEach(n=>{n.data.whoBuy.forEach(async e=>{const t=x(N,e.uid,"teacher"),r=await Ae(t);if(e.studentName=r.data().displayName,e.classSchedule){let o={};o.title=n.data.courseName,o.color=this.teacherData.calenderStudentColor.color,o.textColor=this.teacherData.calenderStudentColor.textColor,o.allDay=!1,o.start=an(e.classSchedule).format("YYYY-MM-DD HH:mm"),o.end=an(e.classSchedule).add(n.data.time,"minute").format("YYYY-MM-DD HH:mm"),this.calenderDataAll.push(o)}})})},async onAuthStateChanged(){Xs(Ai,n=>{console.log("user端資料",n),n?(this.user=n,this.isMember=!0,this.getTeacherFirebaseData(),this.getStudentFirebaseData(),this.getAllCoursesFirebaseData()):(this.isMember=!1,this.getAllCoursesFirebaseData(),console.log("已登出"))})},async onAuthStateChangedForCreateCourse(){Xs(Ai,n=>{n?(this.user=n,this.isMember=!0,this.getTeacherFirebaseData(),console.log("開課囉")):(this.isMember=!1,le.push("/UserLogin"),console.log("已登出"))})},getBookmarkIds(){this.bookmarkIds=JSON.parse(localStorage.getItem("bookmarkIds"))||[]},getBookmarkCoursesData(){this.getBookmarkIds(),this.userBookmarkCourses=[],this.AllCoursesFirebaseData.forEach(n=>{this.bookmarkIds.indexOf(n.id)>-1&&this.userBookmarkCourses.push(n)}),this.bookmarkNum=this.userBookmarkCourses.length,console.log("用戶收藏課程資料",this.userBookmarkCourses)},toggleBookmark(n){const e=n;if(!this.bookmarkIds.some(r=>r===e))this.bookmarkIds.push(n),localStorage.setItem("bookmarkIds",JSON.stringify(this.bookmarkIds));else{const r=this.bookmarkIds.find(o=>o===e);this.bookmarkIds.splice(this.bookmarkIds.indexOf(r),1),localStorage.setItem("bookmarkIds",JSON.stringify(this.bookmarkIds))}this.getBookmarkCoursesData()},async uploadPhoto(n,e){try{const t=e.target.files[0];if(!t)return;const r=await this.beforeUpload(t);if(!r.isValid)throw r.errorMessages;this.to64(n,t)}catch(t){Ot.fire(t),console.log("Catch Error: ",t)}finally{e.target.value=""}},beforeUpload(n){return new Promise(e=>{const r=["image/jpeg","image/png"].includes(n.type),o=[];r||o.push("需上傳 JPG 或 PNG 檔!");const a=n.size/1024/1024<.15;a||o.push("圖片大小需小於0.15MB!"),e({isValid:r&&a,errorMessages:o.join(`
`)})})},to64(n,e){const t=new FormData;t.append("iFile",e);const r=t.get("iFile"),o=new FileReader,a=r.type;o.readAsDataURL(r),o.onload=l=>{/^image\/[jpeg|png|gif]/.test(a)&&(n==="teacher"?(this.teacherData.teacherImg=l.target.result,this.UpdateFirebaseMemberData()):n==="ckeditor"?(this.teacherData.ckeditorImg=l.target.result,this.UpdateFirebaseMemberData()):n==="course"&&(this.beATeacherData.courseImg=l.target.result))}}},getters:{bookmarkState(){return n=>this.bookmarkIds.indexOf(n)>-1?"bi bi bi-bookmark-fill text-white bookmark-on":"bi bi-bookmark text-white bookmark-off"}}});export{Pe as F,ke as G,Ot as S,ef as a,nf as b,Zh as c,cf as d,Ce as e,Xh as f,Cd as g,Xs as o,tf as s};
